...
def create_driver(
    ...
    # Validação de ambiente: Docker exige modo headless obrigatoriamente
    ...
    if browser == "chrome":
        ...
        # Configurações gerais (sempre úteis)
        ...
        if headless:
            ...
            logger.debug("Aplicando argumentos para modo Headless no Edge")
